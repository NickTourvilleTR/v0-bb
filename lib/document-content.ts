// Gyant v. NFM - Complaint.pdf document content organized by pages
...
36. Defendant's unfair settlement practices, as described above, of failing in good faith to effectuate a prompt, fair, and equitable settlement of the claims, even though liability under the Policy was reasonably clear, constitutes an unfair method of competition and an unfair and deceptive act or practice in the business of insurance. See TEX. INS. CODE \u00A7541.051, \u00A7541.060, and \u00A7541.061. Defendants have committed multiple violations of this provision of the Texas Insurance Code \u2013 specifically they have violated this provision relating to each of three properties`,
  },
  {
    pageHeader: "Case 4:25-cv-00064-P Document 1-3 Filed 01/24/25 Page 14 of 510 PageID 26",
    content: `identified herein, respectively. Defendants have directed multiple communications to Plaintiff that violate these provisions of the Texas Insurance Code.

COUNTS 4-6
BREACH OF THE DUTY OF GOOD FAITH AND FAIR DEALING AS TO EACH OF THE THREE PROPERTY LOCATIONS DESCRIBED HEREIN

37. The Defendant's conduct constitutes a breach of the common law and duty of good faith and fair dealing owed to insured in insurance contracts.

38. The Defendant's failure, as described above, to adequately and reasonably investigate and evaluate Gyant's claims as to each of the three properties/claims separately and individually, that Defendant knew or should have known by the exercise of reasonable diligence that their liability was reasonably clear, constitutes a breach of the duty of good faith and fair dealing.

COUNTS 7-9
DECEPTIVE TRADE PRACTICES & UNCONSCIONABLE CONDUCT \u2013 KNOWLEDGE AND INTENT AS TO EACH OF THE THREE PROPERTY LOCATIONS DESCRIBED HEREIN

39. Each of the acts described above, together and singularly, were done "knowingly" and "intentionally" and were producing causes of Gyant's damages described herein pursuant to the Texas Deceptive Trade Practices Consumer Protection Act ("DTPA"), as to each of the three real properties the subject of this lawsuit.

40. Each of the acts described above, together and singularly, constitutes a violation of the DTPA pursuant to its tie-in provisions for Insurance Code violations as set forth herein. Moreover, each of the acts as shown herein shall be construed both separately and together and constitute such violations. Accordingly, Gyant also brings each and every cause of action alleged`,
  },
  {
    pageHeader: "Case 4:25-cv-00064-P Document 1-3 Filed 01/24/25 Page 15 of 510 PageID 27",
    content: `above under the DTPA, pursuant to its tie-in provision, as to each of the three real properties the subject of this lawsuit.

41. At all times material hereto, Gyant was a consumer who acquired, by purchase or lease, goods and/or services from Defendant as to each of the three real properties the subject of this lawsuit. Defendant's acts and/or omissions have violated the DTPA in one or more of the following manners:
...
d. Making false or misleading statements of fact concerning the reasons for, existence of, or amount of reductions;

e. Representing that an agreement confers or involves rights, remedies, or obligations which it does not have or involve, or which are prohibited by law;

f. Misrepresenting the authority of a salesman, representative or agent to negotiate the final terms of a consumer transaction;

g. Failing to disclose information concerning goods or services which was known at the time of the transaction and such failure to disclose such information was intended to induce the consumer into a transaction into which the consumer would not have entered had the information been disclosed; and/or
...
See TEX. BUS. & COM. CODE \u00A717.41 et seq.`,
  },
  {
    ...
    content: `COUNTS 10-12
VIOLATIONS AND NONCOMPLIANCE WITH TEX. INS. CODE CHAPTER 542: "THE PROMPT PAYMENT OF CLAIMS ACT" AS TO EACH OF THE THREE PROPERTY LOCATIONS DESCRIBED HEREIN

42. The Defendant's conduct, as described above, constitutes multiple violations of the Texas Prompt Payment of Claims Act related to the real property damage and/or business personal property damage as to each of the three real properties the subject of this lawsuit. See TEX. INS. CODE, Chapter 542.

43. The Defendant's failure and refusal to properly adjust and investigate Plaintiff's claims, as described above, as to each of the three real properties the subject of this lawsuit constitutes an unreasonable denial of payment of the claim, in violation of TEX. INS. CODE \u00A7542.055-542.060 related to the real property damage and business personal property damage. All violations made under this article are made actionable by TEX. INS. CODE \u00A7542.060.

44. As described herein, Gyant has multiple claims under the Policy. Defendant is fully liable for the claims and has failed to comply with both the Policy's terms, and the statutory requirement of Texas Prompt Payment of Claims Act related to the real property damage and business personal property damage as to each of the three real properties the subject of this lawsuit. See TEX. INS. CODE \u00A7542.051-542.061.
