        ...
        <div className="mx-auto max-w-3xl rounded-lg border border-[#e5e5e5] bg-white p-8">
          ...
          {flowType === "judicial" ? (
            ...
            <>
              ...
              {/* Section II: APPLICABLE LEGAL STANDARDS */}
              <div className="border-b border-[#e5e5e5]">
                <button
                  ...
                  <div className="pb-6 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-[#212223]">
                          Plaintiff alleges that a valid insurance contract existed, Plaintiff performed all conditions required under the policy, Richmond failed to pay benefits allegedly due for remediation-related losses, and Plaintiff suffered damages as a result. These allegations satisfy the basic elements of a contract claim at the pleading stage.
                        </p>
                      </div>

                      <div className="mb-4">
                        <p className="mb-1 text-sm font-semibold text-[#212223]">2. Defendant&apos;s Coverage Argument Does Not Defeat the Claim at This Stage</p>
                        <p className="text-sm text-[#212223]">
                          Richmond&apos;s principal argument is that the policy covers only amounts the insured is legally obligated to pay as "damages," and that the claimed remediation expenses were merely voluntary cleanup costs. That may ultimately prove to be a meritorious coverage defense. However, on the record summarized here, the Court cannot conclude as a matter of law that the claimed losses fall outside the policy&apos;s coverage grant. Absent policy language and facts that conclusively resolve those issues against Plaintiff on the face of the complaint, dismissal is premature.
                        </p>
                      </div>

                      <div className="mb-4">
                        <p className="mb-1 text-sm font-semibold text-[#212223]">3. The No-Voluntary-Payments Argument Also Does Not Warrant Dismissal</p>
                        <p className="text-sm text-[#212223]">
                          Richmond also argues Plaintiff violated the policy&apos;s no-voluntary-payments provision by incurring remediation costs without Richmond&apos;s consent. But whether Plaintiff&apos;s conduct constituted impermissible voluntary payments, whether consent was required under the circumstances, and whether any exception or excuse applies are fact-dependent issues not appropriately resolved on a motion to dismiss unless clearly established by the pleadings. On the present allegations, Plaintiff&apos;s general assertion that it performed all conditions required under the policy is sufficient to withstand dismissal.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mb-2 text-sm text-[#212223]">
                          Because Plaintiff has adequately pleaded the elements of breach of contract and Defendant&apos;s coverage defenses are not conclusively established at the pleading stage, the motion to dismiss the first cause of action should be denied.
                        </p>
                    ...
                    <div>
                      ...
                      <div className="mb-4">
                        <p className="mb-1 text-sm font-semibold text-[#212223]">1. Defendant&apos;s Derivative Argument Fails Because the Contract Claim Survives</p>
                        <p className="text-sm text-[#212223]">
                          Richmond&apos;s primary argument is that the bad faith claim rises or falls with the contract claim. That proposition is generally correct insofar as a bad faith claim requires the withholding of policy benefits due. But because the Court concludes Plaintiff has sufficiently alleged a viable contract claim, Richmond&apos;s derivative challenge does not support dismissal.
                        </p>
                      </div>

                      <div className="mb-4">
                        <p className="mb-1 text-sm font-semibold text-[#212223]">2. Plaintiff Alleges Unreasonable Claims Handling Beyond Mere Denial</p>
                        <p className="text-sm text-[#212223]">
                          Plaintiff does not rely solely on the fact of nonpayment. Plaintiff also alleges Richmond unreasonably delayed claim handling, failed to conduct a thorough, objective, and fair investigation, misrepresented policy terms, and failed to communicate properly. Those allegations, though ultimately subject to proof, are sufficient at the pleading stage to state a plausible claim that Richmond&apos;s handling of the claim was unreasonable.
                        </p>
                      </div>

                      <div className="mb-4">
                        <p className="mb-1 text-sm font-semibold text-[#212223]">3. Defendant&apos;s No-Coverage Position Does Not Eliminate the Claim at This Stage</p>
                        <p className="text-sm text-[#212223]">
                          Richmond may ultimately establish that no benefits were due under the policy, in which event the bad faith claim may fail. But at this juncture, the Court cannot determine as a matter of law that the claim was uncovered. Because potential coverage remains plausibly alleged, the bad faith claim may proceed.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mb-2 text-sm text-[#212223]">
                          Given that the contract claim survives and Plaintiff has alleged unreasonable investigation, delay, denial, and misrepresentation, the bad faith claim is adequately pleaded.
                        </p>
                        <p className="px-4 py-2 bg-[#f7f7f7] rounded text-sm font-semibold text-[#212223]">
              ...
              <div className="border-b border-[#e5e5e5]">
                ...
                {expandedSections.includes("disposition") && (
                  <div className="pb-6 space-y-2">
                    ...
                    <ol className="ml-6 space-y-1 text-sm text-[#212223] list-decimal">
                      <li>First Cause of Action – Breach of Contract: DENIED</li>
                      <li>Second Cause of Action – Bad Faith: DENIED</li>
                    </ol>
                  </div>
                )}
              </div>
            ...
            // BRIEF FLOW OUTLINE (original content)
            <>
              {/* Section I */}
              <div className="border-b border-[#e5e5e5]">
                <button
