...
import { Notebook, Plus, Pencil, ExternalLink, Sparkles, MessageCircleMore, GripVertical, Move, Trash2, ChevronUp, ChevronDown, X, ChevronsUpDown, ChevronsDownUp } from "lucide-react";
