...
const judicialClaims: JudicialClaim[] = [
  {
    ...
    plaintiffSummary: "The court in McCormick v. Sentinel Life Ins. Co. (Cal. App. 2nd Dist. 1984) 153 Cal. App. 3d 1030, 1046 said: \"An insurance company has a duty to pay a claim when it has acquired, though one means or another, sufficient evidence to establish the validity of that claim. It does not have the right to insist the claim be proved only through certain types of evidence. Nor does it exhibit good faith in denying a claim merely because an insured failed to dot the i's or cross the t's on a claim for or other submission...the real question is whether there was enough evidence of whatever form and however acquired that it would be unreasonable for the insurance company to refuse to pay the claim.\" In McCormick, the court reversed the arbitrator's order granting the insurance company's motion for summary judgment.",
    plaintiffPoints: [
      "The California Supreme Court in Isaacson v. California Ins. Guarantee Assn (Cal. 1988) supra at 791 said: \"Accordingly, if an insurer 'erroneously denies coverage and/or improperly refuses to defend the insured' in violation of its contractual duties, 'the insured is entitled to make a reasonable settlement of the claim in good faith and may then maintain an action against the insurer to recover the amount of the settlement.\"",
      "The Isaacson court went onto say: \"Further, if an insurer wrongfully fails to provide coverage or a defense, and the insured then settled the claim, the insured is given the benefit of an evidentiary presumption. In a later action against the insurer for reimbursement based on a breach of its contractual duty to defend the action, a reasonable settlement made by the insured to terminate the underlying claim against him may be used as presumptive evidence of the insured's liability on the underlying claim, and the amount of such liability.\"",
      "Thus, the amounts paid by PLAINTIFF in this case are presumptive evidence of PLAINTIFF'S and thus RNIC's liability.",
    ],
    defendantSummary: "Under California law, non-compliance with a no voluntary payments provision may be excused when an insured is under duress regarding its legal interests. Jamestown Builders, Inc. v. Gen. Star Indem. Co., 77 Cal. App. 4th 341, 348 (1999) (cited by DG Plumbing). For example, non-compliance has been excused when an insured has to incur legal expenses to avoid a default judgment. See, e.g., Fiorito v. Super. Ct., 226 Cal. App. 3d 433, 438 (1990). On the other hand, non-compliance has not been excused when, as here, an insured assumes amounts solely to protect its business interests.",
    defendantPoints: [
      "See, e.g., Umpqua Bank v. First Am. Title Ins. Co., No. CIV. 2:09-3208 WBS, 2011 WL 4852229, at *9 (E.D. Cal. Oct. 12, 2011) (holding that a bank's decision to settle a lawsuit was a business decision that did not fall within the exception), aff'd, 542 F. App'x 635 (9th Cir. 2013); Jamestown Builders, 77 Cal. App. 4th at 344-45, 349 (holding that a developer's payments to repair water intrusion damages before any lawsuits were filed against it did not fall within the exception). For its part, DG Plumbing cites no authority holding that it faced the type of legal risks that allowed it to incur the Remediation Expenses without Richmond's consent. See Pl.'s Opp. at 10-11.",
      "Non-compliance with a no voluntary payments provision may also be excused when an insured is unaware of the identity of its insurer or the contents of the policy. Jamestown Builders, 77 Cal. App. 4th at 348; see also Corthera, Inc. v. Scottsdale Ins. Co., No. 14-CV-05014-EMC, 2016 WL 270951, at *9 (N.D. Cal. Jan. 22, 2016) ('[T]he key is not the involuntary nature of the underlying obligation, but the involuntariness of not giving prior notice to the insurer as required by NVP clauses.'). Here, DG Plumbing was immediately aware of the need to notice the Water Leak to Richmond, but it decided to delay providing that notice.",
