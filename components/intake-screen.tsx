...
import { ArrowRight, ChevronRight, CircleCheck, FileText, List, Paperclip, Reply, FileSearch, Upload } from "lucide-react";
            ...
            {flowType === "judicial" && (
              <QuotableCard label="Uploaded files" onQuote={onQuote} className="mb-6">
                ...
                <div className="mt-4 flex flex-col gap-3">
                  <p className="text-xs font-medium uppercase tracking-wider text-[#737373]">Suggestions:</p>
