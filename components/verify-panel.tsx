            ...
            <div className="mb-6">
              ...
              <div className="mb-6 ml-4">
                ...
                <div className="mb-4 ml-4">
                  ...
                  <p className="mb-3 text-sm leading-relaxed text-[#212223]">
                    A general thematic similarity that is &quot;too general to be protectible for the purposes of the extrinsic test&quot; cannot support a finding of substantial similarity. <a href="#" className="text-[#0062c4] hover:underline"><em>Masterson</em>, 821 F. App&apos;x at 782</a>. The general idea of a woman traveling to Italy to reach a greater understanding of—and peace with—her deceased mother is not protectable.
                  </p>
                  <p className="text-sm leading-relaxed text-[#212223]">
