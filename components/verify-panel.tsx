            ...
            <div className="mb-6">
              ...
              <div className="mb-6 ml-4">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm leading-relaxed text-[#212223]">
                    For literary works, the extrinsic test focuses on &quot;articulable similarities between the plot, themes, dialogue, mood, setting, pace, characters, and sequence of events.&quot; <span className="inline-flex items-center gap-1"><AlertTriangle className="inline size-4 text-[#ab3300]" /><a href="#" className="text-[#0062c4] hover:underline"><em>Metcalf v. Bochco</em>, 294 F.3d 1069, 1073 (9th Cir. 2002)</a></span>. Critically, the threshold step is to filter out unprotectable elements. <em>Woodland</em>, 136 F.4th at 1210. Non-protectable elements include ideas; historical facts; common phrases; scenes-a-faire (situations and incidents that flow naturally or necessarily from a basic plot premise or generic storyline); and familiar stock themes. <em>Corbello</em>, 974 F.3d at 975 (citing <em>Benay v. Warner Bros. Entm&apos;t., Inc.</em>, 607 F.3d 620, 624–25 (9th Cir. 2010)). Only after those elements are set aside does the court compare what remains. That comparative analysis conclusively forecloses any finding of substantial similarity here.
                  </p>
                </div>
