...
import { MessageCardWithQuote } from "@/components/message-card-with-quote";
    ...
    <div className={cn("flex h-full w-[420px] flex-col border-l border-[#e5e5e5] bg-white", className)}>
      ...
      <div ref={chatScrollRef} className="flex-1 overflow-y-auto p-4">
        ...
        {currentStep === "intake" && messages.length > 0 && (
          <MessageCardWithQuote className="mt-2" onQuote={() => console.log("Quoted message")}>
