...
interface ChatDrawerProps {
  ...
  onNextOutline?: () => void;
  onNextDraft?: () => void;
  currentStep?: "argue" | "support-loading" | "support" | "distinguish" | "outline" | "outline-loading" | "outline-ready" | "draft" | "draft-loading" | "draft-ready";
}

type ChatState = "initial" | "adding" | "added";

export function ChatDrawer({ className, isOpen = true, onToggle, onArgumentAdded, onNextSupportingAuthority, onNextContraryAuthorities, onNextOutline, onNextDraft, currentStep = "argue" }: ChatDrawerProps) {
