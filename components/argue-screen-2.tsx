...
export function ArgueScreen2({ className, onNextSupportingAuthority, onSkipToGenerateDraft }: ArgueScreen2Props) {
    ...
    <div className={cn("flex flex-1 flex-col bg-[#fcfcfc]", className)}>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto flex max-w-4xl gap-6 px-6 py-8 pb-32">
          ...
          <div className="self-start sticky top-8 flex flex-col gap-2">
